...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Operates on a zipped excel worksheet. Creates a simpler XML in which elements are named by the column head and their value the cell value in the spreadsheet -->
    ...
    <xsl:variable name="colNames">
        <xsl:for-each select="/worksheet/sheetData/row[1]/c">
