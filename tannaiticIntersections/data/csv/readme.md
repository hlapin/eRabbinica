The files in "pairwise" are based on the string matching work by Avi Shmidman and Moshe Koppel (Dicta), consolidating the differing results when (in comparing texts **A** and **B**), text **A** is base or text **B** is base. 
